 ...
 */
final class Version20241031102727 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creating entities needed for Payment module';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, license_id INT NOT NULL, payment_type_id INT NOT NULL, status SMALLINT DEFAULT NULL, user_comment LONGTEXT DEFAULT NULL, refusal_comment LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6D28840D460F904B (license_id), INDEX IDX_6D28840DDC058279 (payment_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
